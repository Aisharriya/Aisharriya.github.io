...
// 							<Link href={property.link!} key={index} passHref legacyBehavior>
// 								<a
// 									target={'_blank'}
// 									key={index}
...
// 									}}
// 									className='relative flex-center w-1/5 aspect-a4 bg-cover bg-top bg-no-repeat cursor-pointer overflow-hidden border'
// 								>
...
// 										<p className='line-clamp-4 text-xs'>{paper.title}</p>
