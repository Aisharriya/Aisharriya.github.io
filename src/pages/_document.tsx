		...
		<Html>
			<Head>
				...
				<link
					...
					sizes='180x180'
					href='/favicon2/apple-touch-icon.png'
				/>
				<link
					rel='icon'
					type='image/png'
					sizes='32x32'
					href='/favicon2/favicon-32x32.png'
				/>
				<link
					rel='icon'
					type='image/png'
					sizes='16x16'
					href='/favicon2/favicon-16x16.png'
				/>
				...
				<meta
					property='og:title'
					content='Aisharriya | Portfolio Website'
				/>
				<meta
				...
				<meta
					name='keywords'
					content='Aisharriya, Portfolio, Developer, Full-Stack Development'
				/>
				<meta name='author' content='Aisharriya' />
				<meta
